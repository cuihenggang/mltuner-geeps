...
struct Stats {
  ...
  double app_preupdate_time;
  double app_update_time;

  double bg_read_time;
  double bg_read_read_time;
  double bg_read_move_time;
  double bg_postread_time;
  double bg_preupdate_time;
  double bg_update_time;
  double bg_update_move_time;
  double bg_update_update_time;
  ...
  void reset() {
    ...
    bg_preupdate_time = 0;
    bg_update_time = 0;
    bg_update_move_time = 0;
    bg_update_update_time = 0;
    bg_clock_time = 0;
  }
  ...
  std::string to_json() {
    ...
    ss << "{ "
       ...
       << "\"app_preupdate_time\": " << app_preupdate_time << ", "
       ...
       << "\"bg_preupdate_time\": " << bg_preupdate_time << ", "
       << "\"bg_update_time\": " << bg_update_time << ", "
       << "\"bg_update_move_time\": " << bg_update_move_time << ", "
       << "\"bg_update_update_time\": " << bg_update_update_time << ", "
       << "\"bg_clock_time\": " << bg_clock_time << ", "
       << "\"bg_total_time\": "
          << bg_read_read_time + bg_read_move_time + bg_postread_time +
             bg_preupdate_time + bg_update_move_time + bg_update_update_time +
             bg_clock_time << ", "
