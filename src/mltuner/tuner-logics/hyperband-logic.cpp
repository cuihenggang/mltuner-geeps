...
#include "mltuner/tuner-logics/hyperband-logic.hpp"
...
void HyperbandLogic::make_and_schedule_initial_branches() {
...
void HyperbandLogic::state_machine__start_searching() {
...
void HyperbandLogic::state_machine__running() {
...
void HyperbandLogic::state_machine__testing() {
  /* Finish testing */
...
bool HyperbandLogic::get_new_setting() {
...
void HyperbandLogic::hyperband_update() {
...
bool HyperbandLogic::successive_halving_update() {
