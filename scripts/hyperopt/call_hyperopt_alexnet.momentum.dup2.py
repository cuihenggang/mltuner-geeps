...
search_space = (hp.uniform('lr', -5, 0), hp.quniform('slack', 0, 3, 1), hp.quniform('batchsize', 0, 3, 1), hp.uniform('momentum', 0, 1), hp.uniform('lr2', -5, 0), hp.quniform('slack2', 0, 3, 1), hp.quniform('batchsize2', 0, 3, 1), hp.uniform('momentum2', 0, 1))
