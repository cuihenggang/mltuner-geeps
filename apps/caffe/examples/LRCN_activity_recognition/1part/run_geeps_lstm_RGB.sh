...
python ../../../scripts/duplicate.py lstm_solver_RGB.prototxt 1
python ../../../scripts/duplicate.py train_test_lstm_RGB.prototxt 1
python ../../../scripts/duplicate.py sequence_input_layer.py 1 $ sequence_input_layer%i.py
mkdir $1
pwd > $1/pwd
