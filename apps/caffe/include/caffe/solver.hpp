...
struct WorkerBranchInfo {
  int branch_id;
  size_t input_data_idx;
};
typedef boost::unordered_map<int, WorkerBranchInfo *> WorkerBranchInfoMap;
...
class Solver {
 ...
 protected:
  ...
  shared_ptr<BranchManager> branch_manager_;
  WorkerBranchInfoMap branch_info_map_;
  int current_clock_;
  int next_prefetch_clock_;
